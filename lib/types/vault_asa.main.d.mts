...
export function _AdminAPI_replenishSupply5(ctcTop: any, interact: any): Promise<undefined>;
export function _AdminAPI_setAdminProperties5(ctcTop: any, interact: any): Promise<undefined>;
export function _AdminAPI_updateAdminAddress5(ctcTop: any, interact: any): Promise<undefined>;
export function _Any_halt3(ctcTop: any, interact: any): Promise<undefined>;
export function _FeeCollector_collectFees5(ctcTop: any, interact: any): Promise<undefined>;
export function _FeeCollector_dripInterest5(ctcTop: any, interact: any): Promise<undefined>;
export function _Liquidator_liquidateVault5(ctcTop: any, interact: any): Promise<undefined>;
export function _Oracle_updatePrice5(ctcTop: any, interact: any): Promise<undefined>;
export function _VaultOwner_createVault5(ctcTop: any, interact: any): Promise<undefined>;
export function _VaultOwner_depositCollateral5(ctcTop: any, interact: any): Promise<undefined>;
export function _VaultOwner_mintToken5(ctcTop: any, interact: any): Promise<undefined>;
export function _VaultOwner_returnVaultDebt5(ctcTop: any, interact: any): Promise<undefined>;
export function _VaultOwner_withdrawCollateral5(ctcTop: any, interact: any): Promise<undefined>;
export function _VaultRedeemer_proposeVault5(ctcTop: any, interact: any): Promise<undefined>;
export function _VaultRedeemer_redeemVault5(ctcTop: any, interact: any): Promise<undefined>;
...
declare namespace _ALGO {
    ...
    namespace companionInfo {
        const _api_AdminAPI_setAdminProperties4: number;
        const _api_FeeCollector_collectFees4: number;
        const _api_FeeCollector_dripInterest4: number;
        const _api_Liquidator_liquidateVault4: number;
        const _api_VaultOwner_createVault4: number;
        const _api_VaultOwner_depositCollateral4: number;
        const _api_VaultOwner_mintToken4: number;
        const _api_VaultOwner_returnVaultDebt4: number;
        const _api_VaultOwner_withdrawCollateral4: number;
        const _api_VaultRedeemer_proposeVault4: number;
        const _api_VaultRedeemer_redeemVault4: number;
    }
