...
import { vault as vaultBackend, vaultAsa, z_p_f_vaultAsa, large_cp_vault_asa, new_algo_vault, new_asa_vault, } from '@xbacked-dao/xbacked-contracts';
...
export class Vault {
    constructor(params) {
        ...
        if (isSafeKeyOfQ(params.name)) {
            ...
            const asaVault = ((_a = VAULTS[params.network][params.name]) === null || _a === void 0 ? void 0 : _a.new_asa_vault) === false ? undefined : {
                ...
                new_asa_vault: (_b = VAULTS[params.network][params.name]) === null || _b === void 0 ? void 0 : _b.new_asa_vault,
            };
            if (asaVault) {
