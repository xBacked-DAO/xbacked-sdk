...
class Vault {
    constructor(params) {
        var _a;
        this.id = params.id;
        ((_a = params === null || params === void 0 ? void 0 : params.asaVault) === null || _a === void 0 ? void 0 : _a.decimals) ? (this.backend = xbacked_contracts_1.vaultAsa) : (this.backend = xbacked_contracts_1.vault);
    }
    /**
