...
class Account {
    constructor(params) {
        ...
        this.reachStdLib = params.reachStdLib || (0, stdlib_1.loadStdlib)('ALGO');
    ...
    getOtherBalance(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.initialiseReachAccount();
            if (this.reachAccount && params.tokenId !== 0 && params.tokenId !== null) {
                const balance = yield this.reachStdLib.balanceOf(params.address, params.tokenId);
                return balance.toNumber();
            }
            else {
                const balance = yield this.reachStdLib.balanceOf(params.address);
                return balance.toNumber();
            }
        });
    }
