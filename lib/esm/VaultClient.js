...
export class VaultClient extends Account {
    constructor(params) {
        ...
        if (((_a = params === null || params === void 0 ? void 0 : params.asaVault) === null || _a === void 0 ? void 0 : _a.decimals) || ((_b = params === null || params === void 0 ? void 0 : params.asaVault) === null || _b === void 0 ? void 0 : _b.decimals) === 0) {
            ...
            else if ((_f = params === null || params === void 0 ? void 0 : params.asaVault) === null || _f === void 0 ? void 0 : _f.new_sdc_vault) {
    ...
    depositCollateral(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const ctc = this.reachAccount.contract(this.backend, params.vault.id);
            const put = ctc.a.VaultOwner;
            const res = yield put.depositCollateral(convertToMicroUnits(params.amount, this.asaVault ? this.asaVault.decimals : undefined));
            return res;
        });
    }
    /**
    ...
    subscribeToEvents(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (params.liquidateCallback) {
                announcer.liquidateEvent.monitor((event) => {
                    const liquidatorAddress = this.reachStdLib.formatAddress(event.what[0]);
                    const vaultOwner = this.reachStdLib.formatAddress(event.what[1]);
