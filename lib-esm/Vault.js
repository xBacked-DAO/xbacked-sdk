...
var Vault = /** @class */ (function () {
    ...
    Vault.prototype.getState = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var ctc, get, stateViewBefore, vaultStateBefore;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ctc = params.account.reachAccount.contract(backend, this.id);
                        get = ctc.v.State;
                        return [4 /*yield*/, get.read()];
                    case 1:
                        stateViewBefore = _a.sent();
                        vaultStateBefore = stateViewBefore[1];
                        return [2 /*return*/, {
