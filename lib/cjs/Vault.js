...
class Vault {
    constructor(params) {
        ...
        if (isSafeKeyOfQ(params.name)) {
            ...
            const asaVault = ((_a = utils_1.VAULTS[params.network][params.name]) === null || _a === void 0 ? void 0 : _a.new_asa_vault) === false ? undefined : {
                ...
                new_asa_vault: (_b = utils_1.VAULTS[params.network][params.name]) === null || _b === void 0 ? void 0 : _b.new_asa_vault,
            };
            if (asaVault) {
