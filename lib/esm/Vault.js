...
import { vault as vaultBackend, vaultAsa, z_p_f_vaultAsa, large_cp_vault_asa, new_algo_vault, new_asa_vault, new_sdc_vault } from '@xbacked-dao/xbacked-contracts';
...
export class Vault {
    constructor(params) {
        ...
        if (isSafeKeyOfQ(params.name)) {
            ...
            const asaVault = ((_a = VAULTS[params.network][params.name]) === null || _a === void 0 ? void 0 : _a.new_asa_vault) === false &&
                ((_b = VAULTS[params.network][params.name]) === null || _b === void 0 ? void 0 : _b.new_sdc_vault) === false
                ? undefined
                : {
                    decimals: VAULTS[params.network][params.name].assetDecimals === undefined
                        ? 6
                        : VAULTS[params.network][params.name].assetDecimals,
                    z_p_f_vault_asa: false,
                    large_cp_vault_asa: false,
                    new_asa_vault: (_c = VAULTS[params.network][params.name]) === null || _c === void 0 ? void 0 : _c.new_asa_vault,
                    new_sdc_vault: (_d = VAULTS[params.network][params.name]) === null || _d === void 0 ? void 0 : _d.new_sdc_vault,
                };
            if (asaVault) {
